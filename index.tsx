    ...
    <div className="fixed inset-0 z-50 bg-[#1a1a1a] flex flex-col items-center justify-center text-white transition-opacity duration-500">
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="text-[#C5A059] text-xl">侍</span>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          ...
          <Reveal delay={400}>
            <div className="bg-white rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300 group h-full flex flex-col">
              <div className="relative h-64 overflow-hidden">
                <img 
                  src="https://images.unsplash.com/photo-1582793141158-4841570d1d69?q=80&w=1974&auto=format&fit=crop" 
...
const WhyUs = () => {
  const features = [
    ...
    { title: "Authentic Venue", icon: <MapPin className="w-6 h-6" />, desc: "Held inside the lounge of Hotel Aru Kyoto." },
    { title: "Rain or Shine", icon: <div className="font-bold text-xl">☔</div>, desc: "Indoor activity, perfect for rainy days in Kyoto." },
        ...
        <div className="max-w-5xl mx-auto bg-white p-4 shadow-lg rounded-lg">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col justify-center space-y-6 p-4">
              <div>
                <h3 className="font-bold text-lg mb-2 text-[#C5A059]">HOTEL ARU KYOTO</h3>
              ...
              <div className="bg-amber-50 p-3 rounded text-xs text-amber-800 border border-amber-100">
                ...
                Note: Depending on events held inside Aru Hotel, the experience may be provided at the nearby hotel <strong>Rakuran-an</strong> instead.
              </div>
            </div>
          </div>
        </div>
        ...
        <Reveal>
          ...
          <div className="grid md:grid-cols-3 gap-6">
             <div className="bg-white/5 border border-white/10 p-8 rounded-lg hover:border-[#C5A059] transition-all relative overflow-hidden group">
                ...
                <button className="w-full bg-[#C5A059] hover:bg-[#b08d4b] text-white font-bold py-4 rounded transition-colors uppercase tracking-widest flex items-center justify-center">
